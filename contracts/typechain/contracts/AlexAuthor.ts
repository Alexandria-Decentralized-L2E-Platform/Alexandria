...
export interface AlexAuthorInterface extends utils.Interface {
  functions: {
...
export interface AlexAuthor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlexAuthorInterface;
