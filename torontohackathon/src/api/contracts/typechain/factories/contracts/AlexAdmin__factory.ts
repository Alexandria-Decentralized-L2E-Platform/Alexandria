...
type AlexAdminConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class AlexAdmin__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(_feeToken, _authorFee, _cardFee, overrides || {}) as Promise<AlexAdmin>;
  }
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(_feeToken, _authorFee, _cardFee, overrides || {});
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): AlexAdmin {
